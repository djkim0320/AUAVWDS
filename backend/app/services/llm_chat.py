...
class LLMChatOrchestrator:
    ...
    def _system_prompt(self, state_summary: dict[str, Any]) -> str:
        return (
            ...
            "If the user only says they want an aircraft wing without numbers, first ask for basic specs: span in meters, flight goal, and one core geometry preference.\n"
            ...
            "- SetAnalysisConditions when the user explicitly asks for AoA, Mach, or Reynolds changes, or when you need to fill a missing Reynolds before analysis.\n"
            ...
            "- If the user asks for precision/OpenVSP/NeuralFoil analysis and Reynolds is missing, infer a practical Reynolds first. Prefer state_summary.recommended_reynolds when present, call SetAnalysisConditions with it, then run the analysis.\n"
            ...
            "- If user explicitly specifies the wingtip shape, follow it. Otherwise keep wingtip_style as straight. Do not choose pinched tips unless the user clearly asks for that kind of tip treatment.\n"
            ...
            "Do not overwrite an explicit user Reynolds just because recommended_reynolds is available.\n"
