import type { BackendResponse, CommandEnvelope, ModelDiscoveryResponse, SaveSnapshotCompareResponse, SaveSnapshotRecord } from '../types';
...
declare global {
  interface Window {
    auavApi: {
      ...
      exportCfd: (req: { output_path?: string | null }) => Promise<any>;
    };
  }
}
...
export const bridge = {
  ...
  exportCfd: (req: { output_path?: string | null }) => window.auavApi.exportCfd(req),
};
